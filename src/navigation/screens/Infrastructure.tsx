...
const paragraphs = [
  ...
  "Other elements that are not typically associated with childhood but is included in the LCICE are the post office, community associations, etc. While it may seem peripheral, the post office was an essential communication tool for families in Palestine, both within the region and internationally, during this period. Community associations were essential structures in organizing the villages, elections, assigning parcels of land, etc. These are just a few examples of the extensive categories included in the LCICE, with the process still ongoing as new elements are uncovered through data surveying.",
  "An additional benefit of the LCICE is its role in enhancing the search and navigation experience. The categorization will be used as a subject for search tabs, allowing reviewers to navigate to relevant data more efficiently as they explore the archives. ",
];
